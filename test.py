...
df = pd.read_csv("result-sem-6.csv")
...
other = df[(df['Course Name'] != 'Introduction To Internet Of Things') & (df['Course Name'] != 'Introduction To Cognitive Psychology')].sort_values(by = 'Total (100)', ascending=False)
print(other, '\n\n')
